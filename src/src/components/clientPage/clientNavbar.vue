<template>
  <div>
    <nav class="navbar navbar-dark bg-dark flex-md-nowrap p-0 shadow text-center fixed-top">
      <router-link to='/' class="mr-0 p-2 p-lg-4 navbar-brand col-md-4 col-lg-2" href="/dist"><span>小YUYU服飾</span><i class="ml-2 fab fa-firefox"></i></router-link>
      <div class="navbar-nav px-3 d-flex mr-auto">
        <div class="nav-item text-nowrap row">
          <router-link to="/" class="nav-link mx-3" href="/dist">首頁</router-link>
