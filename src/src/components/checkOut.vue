<template>
    <div>
        <h1 class="text-center mt-5">結帳</h1>
        <div class="row mb-5">
            <div class="col-md-4 offset-md-4 mt-3">
                <div class="text-center alert alert-info">請輸入訂單資料</div>
                <div class="text-center alert alert-danger" v-if="error">{{error}}</div>
            </div>
                ...
                <form>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="name" class="form-control" id="name" placeholder="姓名" v-model="name">
                            <span class="text-danger"></span>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="inputEmail4">信箱</label>
                            <input type="email" class="form-control" id="inputEmail4" placeholder="信箱" v-model="email">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="inputtel">電話</label>
                            <input type="tel" class="form-control" id="inputtel" placeholder="電話" v-model="tel">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="address">地址</label>
                            <input type="address" class="form-control" id="address" placeholder="地址" v-model="address">
                        </div>
                    ...
                    <div class="text-right">
                        <button type="submit" class="btn btn-primary" @click="checkOut()">結帳</button>
                    </div>
                </form>
            </div>
        </div>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content border-0">
                        <div class="modal-body bg-dark text-white row">
                            <span class="col my-auto">結帳完成</span>
